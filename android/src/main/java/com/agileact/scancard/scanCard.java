...
@NativePlugin(permissions = { Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE,
        Manifest.permission.READ_EXTERNAL_STORAGE }, requestCodes = { CameraPreview.REQUEST_CAMERA_PERMISSION })
public class ScanCard extends Plugin implements CameraActivity.CameraPreviewListener {
    ...
    public void start(PluginCall call) {
        ...
        if (hasRequiredPermissions()) {
            ...
            pluginRequestPermissions(new String[] { Manifest.permission.CAMERA,
