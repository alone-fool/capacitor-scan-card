...
class Preview extends RelativeLayout implements SurfaceHolder.Callback {
    ...
    public void printPreviewSize(String from) {
        Log.d(TAG, "printPreviewSize from " + from + ": > width: " + mPreviewSize.width + " height: "
                + mPreviewSize.height);
    }
    ...
    public void switchCamera(Camera camera, int cameraId) {
        try {
            ...
            mPreviewSize = getOptimalPreviewSize(mSupportedPreviewSizes, mSurfaceView.getWidth(),
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (changed && getChildCount() > 0) {
            ...
            if (mPreviewSize != null) {
                ...
                // LOG.d(TAG, "previewWidth:" + previewWidth + " previewHeight:" +
                // previewHeight);
            }
